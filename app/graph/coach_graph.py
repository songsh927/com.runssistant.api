...
from app.graph.nodes.profile_rules_node import apply_profile_rules
...
def build_coach_graph(llm: LLMProvider) -> Any:
    ...
    workflow.add_node("apply_profile_rules", apply_profile_rules)
    ...
    workflow.add_edge("apply_rules", "apply_profile_rules")
    workflow.add_edge("apply_profile_rules", "call_coach")
